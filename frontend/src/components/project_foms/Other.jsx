    ...
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-xl rounded-2xl border border-gray-200 my-8 font-sans">
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center gap-2 mb-4">
          <input type="checkbox" id="declaration-check-other" className="accent-amber-600 w-4 h-4 cursor-pointer" />
          <label htmlFor="declaration-check-other" className="cursor-pointer">
